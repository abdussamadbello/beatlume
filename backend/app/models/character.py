...
class Character(Base, OrgScopedMixin, TimestampMixin):
    ...
    archetype: Mapped[str] = mapped_column(String(100), default="", server_default="")
    ...
    fear: Mapped[str] = mapped_column(Text, default="", server_default="")
    flaw: Mapped[str] = mapped_column(Text, default="")
    arc_summary: Mapped[str] = mapped_column(Text, default="", server_default="")
    relationship_notes: Mapped[str] = mapped_column(Text, default="", server_default="")
